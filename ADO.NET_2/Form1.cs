...
namespace Clase6
{
    public partial class Form1 : Form
    {
        ...
        {
            if (usuarios.eliminarUsuario(int.Parse(label6.Text)))
            {
        ...
        {
            if (usuarios.modificarUsuario(int.Parse(label6.Text), int.Parse(textBox1.Text), textBox2.Text, textBox3.Text, textBox4.Text, checkBox1.Checked, checkBox2.Checked))
            {
